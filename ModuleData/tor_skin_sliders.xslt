<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match='skin[@name="man"]/deform_keys/deform_key[@id="weight"]'>
		<deform_key id="TorsoBelly" key_time_point="64" name="Belly Size" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_spine_1" axis="x" key_min="0.95" key_max="1.25" />
				<bone_scale bone_type="biped_spine_1" axis="y" key_min="0.95" key_max="1.25" />
				<bone_scale bone_type="biped_spine_1" axis="z" key_min="1" key_max="1" />
			</bone_scales>
		</deform_key>
		<deform_key id="TorsoHips" key_time_point="65" name="Hip Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="TorsoButt" key_time_point="66" name="Butt Size" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_abdomen" axis="y" key_min="0.94" key_max="1.15" />
			</bone_scales>
		</deform_key>
		<deform_key id="Thigh" key_time_point="67" name="Thigh Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="Calf" key_time_point="68" name="Calf Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="Foot" key_time_point="69" name="Foot Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="TorsoX" key_time_point="70" name="Torso Width" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_spine_2" axis="x" key_min="1" key_max="1.15" />
			</bone_scales>
		</deform_key>
		<deform_key id="TorsoY" key_time_point="71" name="Torso Depth" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_spine_2" axis="y" key_min="1" key_max="1.15" />
			</bone_scales>
		</deform_key>
		<deform_key id="TorsoZ" key_time_point="72" name="Torso Height" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_spine_2" axis="z" key_min="1" key_max="1.15" />
			</bone_scales>
		</deform_key>
		<deform_key id="ThoraxX" key_time_point="73" name="Thorax Width" group_id="0">
			<bone_scales>
		...
		<deform_key id="ThoraxY" key_time_point="74" name="Thorax Depth" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_thorax" axis="y" key_min="1" key_max="1.2" />
				<bone_scale bone_type="biped_thorax" axis="z" key_min="1" key_max="1.02" />
			</bone_scales>
		</deform_key>
		<deform_key id="Neck" key_time_point="75" name="Neck Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="HeadWidth" key_time_point="76" name="Head Size" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_head" axis="x" key_min="1.00" key_max="1.12" />
			</bone_scales>
		</deform_key>
		<deform_key id="HeadDepth" key_time_point="77" name="Head Width" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_head" axis="y" key_min="1.00" key_max="1.12" />
			</bone_scales>
		</deform_key>
		<deform_key id="HeadHeight" key_time_point="78" name="Head Length" group_id="0">
			<bone_scales>
				<bone_scale bone_type="biped_head" axis="z" key_min="1.00" key_max="1.12" />
			</bone_scales>
		</deform_key>
		<deform_key id="Shoulders" key_time_point="79" name="Shoulder Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="UpperarmSize" key_time_point="80" name="Upperarm Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="ForearmSize" key_time_point="81" name="Forearm Size" group_id="0">
			<bone_scales>
		...
		<deform_key id="HandSize" key_time_point="82" name="Hand Size" group_id="0">
			<bone_scales>
