...
public class EonirFavorEnvoyTownBehavior : CampaignBehaviorBase
{
    ...
    private void AddDruchiiEnvoyDialogLines(CampaignGameStarter campaignGameStarter)
    {
        ...
        void ForceWarPrompt()
        {
            ...
            {
                list.Add(new InquiryElement(kingdom, kingdom.FormalName.ToString(), null, true, TORTextHelper.GetText("eonir_druchii_force_war_hint_text", "Force war between two kingdoms")));
            }
    ...
    private void AddAsurEnvoyDialogLines(CampaignGameStarter starter)
    {
        ...
        void AsurDiplomacyPrompt()
        {
            ...
            foreach (var kingdom in humanKingdoms)
            {
                ...
                list.Add(new InquiryElement(kingdom, kingdom.FormalName.ToString(), null, true, TORTextHelper.GetText("eonir_asur_diplomacy_hint_text", "Improve relationship")));
            }
