...
public class OathGoldBehavior : CampaignBehaviorBase
{
    ...
    private void OnSessionLaunched(CampaignGameStarter campaignGameStarter)
    {
        ...
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_decline", "start", "close_window", TORTextHelper.GetTextForNative("tor_dw_guildmaster_reject_non_dwarf", "You don't belong here. begone"),
    ...
    () => Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNESMITH) || Hero.MainHero.PartyBelongedTo.GetMemberHeroes().Any(x => x.HasAttribute(CharacterAttributes.RUNESMITH)) && Hero.MainHero.HasAttribute(CharacterAttributes.GUILD_RUNESMITH_1), openbookconsequence, 200);
        ...
        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_1_p", hub, "tor_dw_guildmaster_rune_smith_hub_rune_lord_career",
            ...
            () => !Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNESMITH) && Hero.MainHero.HasCareer(TORCareers.Runelord), () => FinalizeCareerQuest("runelord_quest_1", 3, "PlayerRunesmith"), 200);
        ...
        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_2_p", hub, "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord",
            ...
            () => Hero.MainHero.HasCareer(TORCareers.Runelord) && Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNESMITH) && !Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNELORD), () => FinalizeCareerQuest("runelord_quest_2", 5, "PlayerRunelord"), 200);
        ...
        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_rune_smith_hub_quit_p", hub, "close_window", TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_hub_quit_p", "That will be all."),
            null, null, 200);
        ...
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_2", TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_hub_rune_lord_career", "By Grungni's beard! It has been a long time indeed since I have seen someone with such potential."),
            () => Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNESMITH) && Hero.MainHero.HasCareer(TORCareers.Runelord), null);
        ...
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_3", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_3", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_4", TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_3", "I am bound to the Grongaz, but you can travel and battle as you please. You have proven yourself worthy, and that is why I share with you my Anvil of Doom. But know this, there are binding oaths of secrecy cast upon it; one cannot simply abandon the Anvil. Protect it with your life."),
            null, null, 200);

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_4", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_4", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_4", "You may use it in battle as you see fit and unleash the ancient runes inscribed upon its surface, but be wary, its runes are powerful, and only the most skilled Rhunki can ever hope to awaken them. The most straightforward combination is the Rune of Hearth and Home. Never forget where you belong and where you came from."),
        ...
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord_0", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord_0", "You get ahead of yourself, Rhunki. Not a long time ago we were still discussing the fundamentals, and now you think you derserve the title of a Runelord? Travel the Karaz Ankor, help our kin in need. Prove yourself worthy of this great honour."),
            () => !Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNELORD), () =>
            {
        ...
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord", "tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord2", TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_hub_rune_lord_career_runelord", "Not since the times of Thorek or even Kragg has a Rhunki displayed such skill in the arts of the runes!"),
            () => Hero.MainHero.HasAttribute(CharacterAttributes.PLAYER_RUNELORD), null);
        ...
        //buy equipment
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_buy_equipment", "tor_dw_guildmaster_rune_smith_buy_equipment", reintro, TORTextHelper.GetTextForNative("tor_dw_shop_show_goods_text", "Very well, take a look at our inventions."),
            null, OpenRuneLordShop, 200);

        // Deliver Steel

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_rune_smith_deliver_steel", "tor_dw_guildmaster_rune_smith_deliver_steel", "tor_dw_guildmaster_rune_smith_deliver_steel_p", TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_deliver_steel", "Those are always welcome, what do you wish to donate?"),
            null, null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_rune_smith_deliver_steel_accept_p", "tor_dw_guildmaster_rune_smith_deliver_steel_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_deliver_steel_accept_p", "Have a look."),
            HasAnyMetal, () => DeliverSteel(), 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_rune_smith_deliver_steel_decline_p", "tor_dw_guildmaster_rune_smith_deliver_steel_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_rune_smith_deliver_steel_decline_p", "That will be all."),
            null, null, 200);
    ...
    private void AddEngineerDialogue(CampaignGameStarter campaignGameStarter)
    {
        ...
        //buy equipment
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_engineer_buy_weapons_shop", "tor_dw_guildmaster_engineer_buy_weapons_shop", "tor_dw_guildmaster_engineer_start_reintro", TORTextHelper.GetTextForNative("tor_dw_shop_show_goods_text", "Very well, take a look at our inventions."),
    ...
    private void AddGemCutterDialogue(CampaignGameStarter campaignGameStarter)
    {
        ...
        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_expedition_hub_found_artefacts_p", hub, "tor_dw_guildmaster_gemcutter_found_artefacts", TORTextHelper.GetTextForNative("tor_dw_guildmaster_expedition_hub_found_artefacts_p", "You find something of interest for me?"),
            () => ActiveExpeditions(), null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_expedition_hub_launch_expedition_p", hub, "tor_dw_guildmaster_gemcutter_launch_expedition", TORTextHelper.GetTextForNative("tor_dw_guildmaster_expedition_hub_launch_expedition_p", "Can I launch an expedition?"),
            () => AbleToLaunchExpeditions(), null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_gemcutter_hub_quit_p", hub, "close_window", TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_hub_quit_p", "That will be all, Master Boki."),
            null, null, 200);

        // found expedition artefacts info
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_gemcutter_found_artefacts", "tor_dw_guildmaster_gemcutter_found_artefacts", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_found_artefacts", "Some of the explorer teams return with treasuers or artifacts. Naturally, a portion would be shared with you."),
            HasUnresolvedExpeditions, AddExpeditionsReward, 200);

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_gemcutter_found_artefacts_no_result", "tor_dw_guildmaster_gemcutter_found_artefacts", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_expedition_found_artefacts_no_expeditions", "The expeditions have not returned yet."),
            null, null, 200);

        //start expedition

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_expedition_launch_expedition_decline", "tor_dw_guildmaster_gemcutter_launch_expedition", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_expedition_launch_expedition_decline", "We are spread too thin; all we can do is wait for our explorers to return."),
            () => !CanLaunchExpedition(), null, 200);

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_expedition_launch_expedition", "tor_dw_guildmaster_gemcutter_launch_expedition", "tor_dw_guildmaster_gemcutter_launch_expedition_p", TORTextHelper.GetTextForNative("tor_dw_guildmaster_expedition_launch_expedition", "Aye, with sufficient funding we can send teams to reclaim treasures from the deepest tunnels of the Underway."),
            null, null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_gemcutter_launch_expedition_accept_p", "tor_dw_guildmaster_gemcutter_launch_expedition_p", "tor_dw_guildmaster_gemcutter_launch_expedition_end", TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_launch_expedition_accept_p", "Let me fund an expeditions."),
            null, () => LaunchExpedition(), 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_gemcutter_launch_expedition_decline_p", "tor_dw_guildmaster_gemcutter_launch_expedition_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_launch_expedition_decline_p", "Forgive me, I changed my mind."),
            null, null, 200);

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_gemcutter_launch_expedition_end", "tor_dw_guildmaster_gemcutter_launch_expedition_end", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_launch_expedition_end", "Very well, our finest explorers and miners will depart after gathering supplies."),
            null, null, 200);
        ...
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_gemcutter_spend_troops", "tor_dw_guildmaster_gemcutter_spend_troops", "tor_dw_guildmaster_gemcutter_spend_troops_p", TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_spend_troops", "Aye, the Guild will appreciate any help in this regard."),
            null, null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_gemcutter_spend_troops_accept_p", "tor_dw_guildmaster_gemcutter_spend_troops_p", "tor_dw_guildmaster_gemcutter_spend_troops_end", TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_spend_troops_accept_p", "Let me station these men."),
            null, () => ProvideTroops(), 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_gemcutter_spend_troops_decline_p", "tor_dw_guildmaster_gemcutter_spend_troops_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_spend_troops_decline_p", "I changed my mind, forgive me."),
            null, null, 200);


        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_gemcutter_spend_troops_end", "tor_dw_guildmaster_gemcutter_spend_troops_end", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_gemcutter_spend_troops_end", "This is greatly appreciated, Dawongr."),
            null, null, 200);
    ...
    private void AddBrewerDialogue(CampaignGameStarter campaignGameStarter)
    {
        ...
        // spend food
        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_brewer_hub_spend_food", "tor_dw_guildmaster_brewer_hub_spend_food", "tor_dw_guildmaster_brewer_hub_spend_food_p", TORTextHelper.GetTextForNative("tor_dw_guildmaster_brewer_hub_spend_food", "It is how we brew our finest ale. An' we can always use more Gertun."),
            null, null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_brewer_hub_spend_food_accept_p", "tor_dw_guildmaster_brewer_hub_spend_food_p", "tor_dw_guildmaster_brewer_hub_spend_food_end", TORTextHelper.GetTextForNative("tor_dw_guildmaster_brewer_hub_spend_food_accept_p", "Have these sacks of grain then."),
            null, () => SpendFood(), 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_brewer_hub_spend_food_decline_p", "tor_dw_guildmaster_brewer_hub_spend_food_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_brewer_hub_spend_food_decline_p", "Actually I changed my mind."),
            null, null, 200);

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_brewer_hub_spend_food_end", "tor_dw_guildmaster_brewer_hub_spend_food_end", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_brewer_hub_spend_food_end", "Thank ye for yer contribution."),
            null, null, 200);
    ...
    private void AddWarriorDialogue(CampaignGameStarter campaignGameStarter)
    {
        ...
        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_warrior_hub_quit_p", hub, "close_window", TORTextHelper.GetTextForNative("tor_dw_quit_text", "That will be all."),
            null, null, 200);


        // spend troops

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_warrior_spend_troops", "tor_dw_guildmaster_warrior_spend_troops", "tor_dw_guildmaster_warrior_spend_troops_p", TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_spend_troops", "Honoured warriors of sure grip and stern eye are always welcome."),
            null, null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_warrior_spend_troops_accept_p", "tor_dw_guildmaster_warrior_spend_troops_p", "tor_dw_guildmaster_warrior_spend_troops_end", TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_spend_troops_accept_p", "In that case I will leave these Dawi with you."),
            HasTransferableTroops, () => ProvideTroops(), 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_warrior_spend_troops_decline_p", "tor_dw_guildmaster_warrior_spend_troops_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_spend_troops_decline_p", "Forgive me, I changed my mind."),
            null, null, 200);


        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_warrior_spend_troops_end", "tor_dw_guildmaster_warrior_spend_troops_end", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_spend_troops_end", "We appreciate any warrior you can spare."),
            null, null, 200);


        // influence

        campaignGameStarter.AddDialogLine("tor_dw_guildmaster_warrior_influence_for_oath", "tor_dw_guildmaster_warrior_influence_for_oath", "tor_dw_guildmaster_warrior_influence_for_oath_p", TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_influence_for_oath", "With a donation of Oathgold our warriors will spread the Influence of your Clan across the Karaz Ankor."),
            null, null, 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_warrior_influence_for_oath_accept_p", "tor_dw_guildmaster_warrior_influence_for_oath_p", "tor_dw_guildmaster_warrior_influence_for_oath", TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_influence_for_oath_accept_p", "We have a deal, that is a worthy trade."),
            CanTransferOathGoldForInfluence, () => BuyInfluenceForOathGold(), 200);

        campaignGameStarter.AddPlayerLine("tor_dw_guildmaster_warrior_influence_for_oath_decline_p", "tor_dw_guildmaster_warrior_influence_for_oath_p", reintro, TORTextHelper.GetTextForNative("tor_dw_guildmaster_warrior_influence_for_oath_decline_p", "Actually I changed my mind."),
            null, null, 200);
