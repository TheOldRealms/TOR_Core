...
namespace TOR_Core.CampaignMechanics.CustomDialogs
{
    public class BloodKissCampaignBehavior : CampaignBehaviorBase
    {
        ...
        private void OnStart(CampaignGameStarter starter)
        {
            ...
            starter.AddPlayerLine("bloodkiss_iamready", "bloodkiss_blooddragon_areyouready", "bloodkiss_blooddragon_player_ready", "{=tor_bloodkiss_blooddragon_player_ready_str}I am ready, Grandmaster.", null, null);
            starter.AddPlayerLine("bloodkiss_iamnotready", "bloodkiss_blooddragon_areyouready", "bloodkiss_player_notready", "{=tor_bloodkiss_blooddragon_player_notready_str}On a second thought, I need to think about it.", null, null);

            starter.AddDialogLine("bloodkiss_recieve", "bloodkiss_blooddragon_player_ready", "bloodkiss_blooddragon_playcutscene", "{=tor_bloodkiss_blooddragon_receive_str}Embrace the Bloodkiss, become one with the night, and ascend to greatness alongside the Blood Dragons.", null, null);
            starter.AddDialogLine("bloodkiss_cutscene", "bloodkiss_blooddragon_playcutscene", "close_window", "{=tor_bloodkiss_blooddragon_player_receive_end_str}Rise, young blood dragon.", null, OnBloodKissBloodDragonRecieved);
            ...
            starter.AddPlayerLine("bloodkiss_iamready", "bloodkiss_areyouready", "bloodkiss_player_ready", "{=tor_bloodkiss_player_ready_str}I am ready my lord.", null, null);
            ...
            starter.AddDialogLine("bloodkiss_recieve", "bloodkiss_player_ready", "bloodkiss_playcutscene", "{=tor_bloodkiss_receive_str}Prepare thine self for thine dark awakening.", null, null);
            starter.AddDialogLine("bloodkiss_cutscene", "bloodkiss_playcutscene", "close_window", "{=tor_bloodkiss_player_receive_end_str}Rise, von Carstein scion.", null, OnBloodKissRecieved);
