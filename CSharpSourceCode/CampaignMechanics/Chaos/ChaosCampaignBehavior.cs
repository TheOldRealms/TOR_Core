...
namespace TOR_Core.CampaignMechanics.Chaos
{
    public class ChaosCampaignBehavior : CampaignBehaviorBase
    {
        ...
        private void DailyTick()
        {
            ...
            {
                var mostPowerfulKingdom = Kingdom.All.WhereQ(x => (x.Culture.StringId == "empire" || x.Culture.StringId == TORConstants.BRETONNIA_CULTURE) && x.Fiefs.Count > 1).MaxBy(x => x.TotalStrength);
