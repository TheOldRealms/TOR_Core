...
namespace TOR_Core.CampaignMechanics.RaiseDead
{
    public class RaiseDeadInTownBehavior : CampaignBehaviorBase
    {
        ...
        ///<remarks>
        ///Necromancer attributes are not in the extended info for any hero; if a hero knows a spell from the necromancry lore, then they are effectively a Necromancer even without the attribute. Any ai non-spellcasters will gain the attribute here. This does mean that something like a wight king companion will gain the Necromancer attribute.
        /// </remarks>
