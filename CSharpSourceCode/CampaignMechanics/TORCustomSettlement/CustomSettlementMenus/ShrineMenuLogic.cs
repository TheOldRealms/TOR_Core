...
public class ShrineMenuLogic : TORBaseSettlementMenuLogic
{
    ...
    {
        return party.IsLordParty && party.LeaderHero != null && !party.IsEngaging && party.IsActive && !party.IsDisbanding && !party.IsCurrentlyUsedByAQuest && party.CurrentSettlement == null && party.MapEvent == null && !party.Ai.IsDisabled && party.Army == null && !party.HasAnyActiveBlessing();
    }
