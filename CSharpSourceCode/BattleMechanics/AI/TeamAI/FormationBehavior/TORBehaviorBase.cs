...
namespace TOR_Core.BattleMechanics.AI.TeamAI.FormationBehavior
{
    ...
    public abstract class TORBehaviorBase : BehaviorComponent
    {
        ...
        private void CalculateFormationQueryData()
        {
            ...
            else if (Formation.CachedClosestEnemyFormation?.Formation?.CountOfUnits > 0) FormationQueryData.TargetFormation = Formation.CachedClosestEnemyFormation.Formation;
        ...
        private void SetOrders()
        {
            if (Formation.AI.ActiveBehavior == this)
            {
                ...
                Formation.SetArrangementOrder(CurrentArrangementOrder);
                Formation.SetFiringOrder(CurrentFiringOrder);
                Formation.SetFormOrder(CurrentFormOrder);
                OnAfterOrdersSet();
            }
        }
