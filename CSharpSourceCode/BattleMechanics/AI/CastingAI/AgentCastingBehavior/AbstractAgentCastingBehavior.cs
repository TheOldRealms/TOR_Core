    ...
    public abstract class AbstractAgentCastingBehavior : IAgentBehavior
    {
        ...
        public virtual void Execute()
        {
            ...
            if (spawnLogic != null)
            {
                ...
                if (ongoingReinforcementSpawning)
                {
                    return; //attempting to stop the AI from trying to nuke hundreds of troops right as they're spawned in to address access violations issues
                }
            }
