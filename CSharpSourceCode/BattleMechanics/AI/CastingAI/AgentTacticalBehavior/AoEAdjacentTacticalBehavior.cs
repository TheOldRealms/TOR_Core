...
namespace TOR_Core.BattleMechanics.AI.CastingAI.AgentTacticalBehavior
{
    public class AdjacentAoETacticalBehavior : AbstractAgentTacticalBehavior
    {
        ...
        {
            var medianPosition = targetFormation.CachedMedianPosition;
            return medianPosition.GetGroundVec3MT() + (targetFormation.Direction * targetFormation.CachedMovementSpeed).ToVec3(medianPosition.GetGroundZMT());
        }
