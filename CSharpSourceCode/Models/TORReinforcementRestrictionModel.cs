...
{
    public class TORReinforcementRestrictionModel : GameModel
    {
        public virtual bool CanPartyJoinRequestedSide(MapEvent mapEvent, PartyBase joiningParty, BattleSideEnum side)
        {
        ...
        protected virtual bool IsRestrictedCulture(string cultureId)
        {
        ...
        protected virtual bool CanCultureHelpCulture(string helperCultureId, string targetCultureId)
        {
