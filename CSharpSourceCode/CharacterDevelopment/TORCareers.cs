...
namespace TOR_Core.CharacterDevelopment
{
    public class TORCareers
    {
        ...
        private void InitializeAll()
        {
            ...
            _knightOldWorld.Initialize("Knight of the Old World", null, "KnightlyStrike", CareerAbilityChargeSupplier.KnightOldWorldChargeSupplier, 500, typeof(KnightlyStrike));
