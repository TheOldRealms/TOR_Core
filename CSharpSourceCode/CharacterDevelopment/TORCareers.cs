...
namespace TOR_Core.CharacterDevelopment
{
    public class TORCareers
    {
        ...
        private void InitializeAll()
        {
            ...
            _warriorPriestUlric.Initialize("Warrior Priest of Ulric", null, "AxeOfUlric", CareerAbilityChargeSupplier.WarriorPriestUlricCharge, 200, typeof(AxeOfUlricScript));
        }
    }
}