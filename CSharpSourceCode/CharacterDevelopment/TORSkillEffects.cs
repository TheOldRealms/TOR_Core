...
namespace TOR_Core.CharacterDevelopment
{
    public class TORSkillEffects
    {
        ...
        public TORSkillEffects()
        {
            ...
            _gunReloadSpeed.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_gun_reload_speed", "Gunpowder firearms reload speed: +{a0} %"),
            TORSkills.GunPowder, PartyRole.Personal, 0.0007f, EffectIncrementType.AddFactor, 0f, 0f);

            _gunAccuracy.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_gun_accuracy", "Gunpowder firearms accuracy: +{a0} %"),
            TORSkills.GunPowder, PartyRole.Personal, 0.0005f, EffectIncrementType.AddFactor, 0f, 0f);

            _spellEffectiveness.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_spell_effectiveness", "Spell effectiveness: +{a0} %"),
            TORSkills.Spellcraft, PartyRole.Personal, 0.0005f, EffectIncrementType.AddFactor, 0f, 0f);

            _spellDuration.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_spell_duration", "Spell duration: +{a0} %"),
            TORSkills.Spellcraft, PartyRole.Personal, 0.0005f, EffectIncrementType.AddFactor, 0f, 0f);

            _windsRechargeRate.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_winds_recharge_rate", "Winds of magic recharge rate: +{a0} / hour"),
            TORSkills.Spellcraft, PartyRole.Personal, 0.0075f, EffectIncrementType.Add, 0f, 0f);

            _maxWinds.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_max_winds", "Maximum winds of magic: +{a0}"),
            TORSkills.Spellcraft, PartyRole.Personal, 0.3f, EffectIncrementType.Add, 0f, 0f);

            _faithWardSave.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_ward_save", "Ward save: +{a0} %"),
            TORSkills.Faith, PartyRole.Personal, 0.0008f, EffectIncrementType.AddFactor, 0f, 0f);

            _blessingDuration.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_blessing_duration", "Blessing duration increase: +{a0} %"),
            TORSkills.Faith, PartyRole.PartyLeader, 0.01f, EffectIncrementType.AddFactor, 0f, 0f);

            _prayerEffectiveness.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_prayer_effectiveness", "Prayer effectiveness(Only Priests): +{a0} %"),
            TORSkills.Faith, PartyRole.Personal, 0.00025f, EffectIncrementType.AddFactor, 0f, 0f);

            _prayerDuration.Initialize(TORTextHelper.GetTextObject("str_tor_skill_effect_prayer_duration", "Prayer duration increase(Only Priests): +{a0} %"),
            TORSkills.Faith, PartyRole.Personal, 0.00025f, EffectIncrementType.AddFactor, 0f, 0f);
        }
    }
}