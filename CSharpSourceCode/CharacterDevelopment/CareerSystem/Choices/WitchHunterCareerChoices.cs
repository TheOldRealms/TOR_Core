...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class WitchHunterCareerChoices(CareerObject id) : TORCareerChoicesBase(id)
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _swiftProcedurePassive3.Initialize(CareerID, "Party movement speed is increased by 1.5", "SwiftProcedure", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(1.5f, PassiveEffectType.PartyMovementSpeed));
            ...
            _guiltyByAssociationPassive1.Initialize(CareerID, "Increases troop regeneration by 2.", "GuiltyByAssociation", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(2, PassiveEffectType.TroopRegeneration)); //same formulation as other careers?
