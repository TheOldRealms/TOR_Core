...
public class OrcBossCareerChoices(CareerObject id) : TORCareerChoicesBase(id)
{
    ...
    protected override void InitializePassives()
    {
        ...
        _meanestanDaBaddestPassive3.Initialize(CareerID, "Get 50% more when leavin’ shinies wit da Kwartamasta", "MeanestanDaBaddest", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(100, PassiveEffectType.Special, true));
