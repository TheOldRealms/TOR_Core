...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class GrailKnightCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _errantryWarPassive3.Initialize(CareerID, "{=errantry_war_passive3_str}All Knight troops receive 20 bonus points in One and Two Handed skills.", "ErrantryWar", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.Special)); //
            ...
            _enhancedHorseCombatPassive2.Initialize(CareerID, "{=enhanced_horse_combat_passive2_str}10% extra melee damage while on horseback.", "EnhancedHorseCombat", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.Special, true)); //
            ...
            _enhancedHorseCombatPassive4.Initialize(CareerID, "{=enhanced_horse_combat_passive4_str}All Knight troops receive 30 bonus points in their Polearm skill.", "EnhancedHorseCombat", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(30, PassiveEffectType.Special)); //
            ...
            _questingVowPassive2.Initialize(CareerID, "{=questing_vow_passive2_str}Gain 15% physical resistance to melee and ranged attacks.", "QuestingVow", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Resistance, new DamageProportionTuple(DamageType.Physical, 15), AttackTypeMask.Ranged | AttackTypeMask.Melee));
            _questingVowPassive3.Initialize(CareerID, "{=questing_vow_passive3_str}All Knight troops gain 10% physical resistance.", "QuestingVow", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.Special, true));
            _questingVowPassive4.Initialize(CareerID, "{=questing_vow_passive4_str}Hits below 15 damage will not stagger the player.", "QuestingVow", false, ChoiceType.Passive, null); // Agent extension 83,
            ...
            _monsterSlayerPassive4.Initialize(CareerID, "{=monster_slayer_passive4_str}All Peasant troops wages are reduced by 75%.", "MonsterSlayer", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-75, PassiveEffectType.Special, true));

            _masterHorsemanPassive1.Initialize(CareerID, "{=master_horseman_passive1_str}Horse charge damage is increased by 50%.", "MasterHorseman", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.HorseChargeDamage, true));
            ...
            _masterHorsemanPassive3.Initialize(CareerID, "{=master_horseman_passive3_str}+4 health regeneration on the campaign map.", "MasterHorseman", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(4, PassiveEffectType.HealthRegeneration, false));
            _masterHorsemanPassive4.Initialize(CareerID, "{=master_horseman_passive4_str}All Knight troops wages are reduced by 25%.", "MasterHorseman", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-25, PassiveEffectType.Special, true));
