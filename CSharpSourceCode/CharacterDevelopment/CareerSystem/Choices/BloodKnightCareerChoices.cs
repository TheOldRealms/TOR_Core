...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class BloodKnightCareerChoices : TORCareerChoiceBase
    {
            ...
            _bloodKnightRoot.Initialize(TORCareers.BloodKnight, "root", null, true,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new CareerChoiceObject.MutationObject()
                    {
                        ...
                        MutationTargetOriginalId = "BloodFury",
        ...
        protected override void InitializePassives()
        {
            ...
            _bladeMasterPassive4.Initialize(TORCareers.BloodKnight, "All troops are gaining xp and all melee combat skills are leveled while raiding villages", "BladeMaster", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25));
            
            _doomRiderPassive1.Initialize(TORCareers.BloodKnight, "Villageraids are 20% more efficient.", "DoomRider", false, ChoiceType.Passive, null,new CareerChoiceObject.PassiveEffect(20f,PassiveEffectType.Special,true )); 
            ...
            _dreadKnightPassive4.Initialize(TORCareers.BloodKnight, "15% Wardsave", "DreadKnight", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Resistance, new DamageProportionTuple(DamageType.All,15),AttackTypeMask.All));
