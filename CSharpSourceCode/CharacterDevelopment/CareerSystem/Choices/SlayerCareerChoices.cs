...
public class SlayerCareerChoices(CareerObject id) : TORCareerChoicesBase(id)
{
    ...
    protected override void InitializePassives()
    {
        ...
        _giantSlayerPassive4.Initialize(CareerID, "You can no longer be staggered by damage.", "GiantSlayer", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(1, PassiveEffectType.ShruggedOff));
