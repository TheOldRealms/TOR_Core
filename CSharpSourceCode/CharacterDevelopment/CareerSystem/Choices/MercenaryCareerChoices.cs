...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class MercenaryCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _survivalistPassive3.Initialize(CareerID, "Increases MovementSpeed inside forests by 20%.", "Survivalist", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.Special, true));
            _survivalistPassive4.Initialize(CareerID, "Once per day, you go for a hunt. Your success is determined by your Scouting and ranged and polearm capabilities", "Survivalist", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0));
            ...
            _duelistPassive3.Initialize(CareerID, "Infantry wages are reduced by 20%.", "Duelist", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-20, PassiveEffectType.Special, true));
            ...
            _headhunterPassive3.Initialize(CareerID, "You earn 500 gold from high values targets(Lords, Bandit bosses), if you or your party eliminates it.", "Headhunter", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(500, PassiveEffectType.Special));
            ...
            _knightlyPassive4.Initialize(CareerID, "Ignores 15% armor for every melee hit", "Knightly", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-15, PassiveEffectType.Special, true));

            _mercenaryLordPassive1.Initialize(CareerID, "4 extra special ammunition grenades or buckshots.", "MercenaryLord", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(4, PassiveEffectType.Special, false));
            _mercenaryLordPassive2.Initialize(CareerID, "15% extra damage for all ranged units.", "MercenaryLord", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(15, PassiveEffectType.Special, true));
            _mercenaryLordPassive3.Initialize(CareerID, "Payment in a mercenary contract are higher, while less  influence is lost. The effect can be enhanced by a higher Merchant skill.", "MercenaryLord", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.Special, true));
            _mercenaryLordPassive4.Initialize(CareerID, "Based on your trading skill, you get a bonus on top for your mercenary contract payment", "MercenaryLord", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special));

            _commanderPassive1.Initialize(CareerID, "Wages for Tier 4 Units and higher are reduced by 20%", "Commander", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-20, PassiveEffectType.Special, true));
            _commanderPassive2.Initialize(CareerID, "15% extra damage for all melee units.", "Commander", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(15, PassiveEffectType.Special, true));
            _commanderPassive3.Initialize(CareerID, "Damages below 15 points do not stagger character", "Commander", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special));
            _commanderPassive4.Initialize(CareerID, "There is a 40% chance when recruiting units to recruit another of the same type for free.", "Commander", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.Special, true));
        }
    }
}