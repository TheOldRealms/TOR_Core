...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class MercenaryCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _mercenaryLordPassive3.Initialize(CareerID, "Mercenary contracts 'Influence' cost, and payout scale with your Trade skill.", "MercenaryLord", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special)); // TOR_Core.Models.TORClanFinanceModel. 53
            _mercenaryLordPassive4.Initialize(CareerID, "+100% 'Prestige' from battles. Gain another 100% if Leadership reaches 300.", "MercenaryLord", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special)); //CustomResourceManager
