...
namespace TOR_Core.CharacterDevelopment.CareerSystem
{
    public class WarriorPriestCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _protectorOfTheWeakPassive1.Initialize(CareerID, "Increases Hitpoints by {EFFECT_VAUE}.", "ProtectorOfTheWeak", false, ChoiceType.Passive, null,new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.Health));
