...
namespace TOR_Core.CharacterDevelopment.CareerSystem
{
    public class WarriorPriestCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _relentlessFanaticPassive1.Initialize(CareerID, "{=relentless_fanatic_passive1_str}Increases Hitpoints by 20.", "RelentlessFanatic", false, ChoiceType.Passive, null,new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.Health));
            ...
            _relentlessFanaticPassive3.Initialize(CareerID, "{=relentless_fanatic_passive3_str}Sigmarite troops get 25% resistance to physical ranged attacks.", "RelentlessFanatic", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special));      //TORAgentStatCalculateModel 345
            _relentlessFanaticPassive4.Initialize(CareerID, "{=relentless_fanatic_passive4_str}Party movement speed is increased by 1.", "RelentlessFanatic", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(1, PassiveEffectType.PartyMovementSpeed));

            _protectorOfTheWeakPassive1.Initialize(CareerID, "{=protector_of_the_weak_passive1_str}Increases Hitpoints by 20.", "ProtectorOfTheWeak", false, ChoiceType.Passive, null,new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.Health));
            ...
            _holyPurgePassive1.Initialize(CareerID, "{=holy_purge_passive1_str}10% extra holy melee damage.", "HolyPurge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Holy,10),AttackTypeMask.Melee));
            _holyPurgePassive2.Initialize(CareerID, "{=holy_purge_passive2_str}All Sigmarite troops gain 10% Ward save.", "HolyPurge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.Special, true));      //TORAgentStatCalculateModel 345 
            _holyPurgePassive3.Initialize(CareerID, "{=holy_purge_passive3_str}All troops deal 10% more melee damage to non-human enemies.", "HolyPurge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.Special,true)); 
            _holyPurgePassive4.Initialize(CareerID, "{=holy_purge_passive4_str}All Sigmarite troops gain 10% extra Holy damage.", "HolyPurge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Holy,10),AttackTypeMask.All));
            ...
            _archLectorPassive4.Initialize(CareerID, "{=arch_Lector_passive4_str}Prayers aren't affected by global cooldowns.", "ArchLector", false, ChoiceType.Passive, null);   //Ability 132
        }
