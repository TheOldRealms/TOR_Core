...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class GrailDamselCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializeKeyStones()
        {
            ...
            _justCauseKeystone.Initialize(CareerID, "{=just_cause_keystone_str}Magical damage for troops close to the exit of the teleport is increased by 30% for 5 seconds", "JustCause", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new CareerChoiceObject.MutationObject()
                    {
        ...
        protected override void InitializePassives()
        {
            ...
            _inspirationOfTheLadyPassive2.Initialize(CareerID, "{=inspiration_of_the_lady_passive2_str}Wounded troops in your party heal faster.", "InspirationOfTheLady", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(2, PassiveEffectType.TroopRegeneration)); //write description to be precise
            ...
            _vividVisionsPassive2.Initialize(CareerID, "{=vivid_visions_passive2_str}Party movement speed is increased by 1.", "VividVisions", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(1, PassiveEffectType.PartyMovementSpeed));
            ...
            _vividVisionsPassive4.Initialize(CareerID, "{=vivid_visions_passive4_str}The Spotting range of the party is increased by 20%.", "VividVisions", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.PartySpottingRange, true));
            ...
            _envoyOfTheLadyPassive2.Initialize(CareerID, "{=envoy_of_the_lady_Passive2_str}Knight Companion health increases by 100.", "EnvoyOfTheLady", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(100, PassiveEffectType.Special, true));
