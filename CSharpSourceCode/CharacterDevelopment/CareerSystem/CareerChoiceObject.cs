...
namespace TOR_Core.CharacterDevelopment.CareerSystem
{
    public class CareerChoiceObject : PropertyObject
    {
        ...
        public void Initialize(CareerObject ownerCareer, string description, string belongsToGroup, bool isRootNode, ChoiceType type, List<MutationObject> mutations = null, PassiveEffect passiveEffect = null)
        {
            ...
            base.Initialize(new TextObject(StringId), text);//Sly : the string id doesn't contain the localization id, but does this text ever appear anywhere?
    ...
    //If you want to mix percentage bonuses with flat ones, make use of InterpretAsPercentage and WithFactorFlatSwitch.
    public enum PassiveEffectType
    {
        ...
        TroopDamage,
        TroopResistance,
        TroopRegeneration,  //troop regeneration - heroes unaffected. The value is applied to all troops with no way to differentiate.
        TroopMorale,        //Morale
