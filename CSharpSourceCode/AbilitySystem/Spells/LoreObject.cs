    ...
    public class LoreObject
    {
        ...
        public static List<LoreObject> GetAll()
        {
            if (_lores.Count == 0)
            {
                ...
                _lores.Add("LoreOfBeasts", new LoreObject("LoreOfBeasts", "Lore of Beasts", "beastmagic_symbol", new List<string>() { TORConstants.Cultures.SYLVANIA, TORConstants.Cultures.MOUSILLON, TORConstants.Cultures.ASRAI, TORConstants.Cultures.DAWI, TORConstants.Cultures.GREENSKIN }));
                _lores.Add("HighMagic", new LoreObject("HighMagic", "High Magic", "highmagic_symbol", new List<string>() { TORConstants.Cultures.EMPIRE, TORConstants.Cultures.BRETONNIA, TORConstants.Cultures.MOUSILLON, TORConstants.Cultures.SYLVANIA, TORConstants.Cultures.DAWI, TORConstants.Cultures.GREENSKIN }, true));
                ...
                _lores.Add("LoreOfDeath", new LoreObject("LoreOfDeath", "Lore of Death", "deathmagic_symbol", new List<string>() { TORConstants.Cultures.BRETONNIA, TORConstants.Cultures.ASRAI, TORConstants.Cultures.DAWI, TORConstants.Cultures.SYLVANIA, TORConstants.Cultures.MOUSILLON, TORConstants.Cultures.GREENSKIN }));
