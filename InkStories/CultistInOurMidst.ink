...
=choices
*[Approach the group and listen in on their conversation. {print_player_skill_chance("Roguery", NormalSkillCheckValue)}] -> scouting_check
...
=choices
*{ElderState == 2}[Confront the elder about his apparent wealth accusing him of illicit activities. {print_player_skill_chance("Charm", HardSkillCheckValue)}] -> guilty
* -> InvestigateVillagers.choices
